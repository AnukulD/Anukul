...
filepath = 'C:\Users\Anukul Dewangan\Desktop\Plant-Leaf-Disease-Prediction-main'
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:\Users\Anukul Dewangan\Desktop\Plant-Leaf-Disease-Prediction-main\static\upload', filename)
        file.save(file_path)
